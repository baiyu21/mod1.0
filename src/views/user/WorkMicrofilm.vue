  ...
  <div class="ef-form">
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="指导教师">
              <el-input v-model="baseForm.tutor1" placeholder="指导教师姓名" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="指导教师">
              <el-input v-model="baseForm.tutor2" placeholder="指导教师姓名" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="指导教师">
              <el-input v-model="baseForm.tutor3" placeholder="指导教师姓名" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
    ...
    <el-card shadow="never" class="ef-section-card">
      ...
      >
        ...
        <template #tip>
          <div class="el-upload__tip">支持 mp4/mov 等视频，及海报、剧照、脚本PDF等。</div>
        </template>
      </el-upload>
    </el-card>
